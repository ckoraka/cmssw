...
namespace {
  edm::ParameterSetDescription makeMatchingCutsPSetDescription() {
  ...
  public:
    ElectronNHitSeedAlpakaProducer(const edm::ParameterSet& pset)
        : EDProducer(pset),
          ...
          matchingCuts_{makeMatchingCuts<nMaxEtaBins, nMaxHits>(pset.getParameter<std::vector<edm::ParameterSet> >("matchingCuts"))}
    {}
    ...
    static void fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
      ...
      desc.add<edm::ParameterSetDescription>("matchingCuts", makeMatchingCutsPSetDescription());
      descriptions.addWithDefaultLabel(desc);
    }

  private:
    static constexpr size_t nMaxEtaBins = 1;
    static constexpr size_t nMaxHits = 3;
