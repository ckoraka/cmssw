...
namespace reco {
  ...
  GENERATE_SOA_LAYOUT(EleSeedLayout,
                      ...
                      SOA_COLUMN(int8_t, matchedScID),
                      SOA_COLUMN(int8_t, id),
                      SOA_COLUMN(int8_t, hit0detectorID),
                      SOA_COLUMN(int8_t, hit0isValid),
                      SOA_COLUMN(int8_t, hit1detectorID),
                      SOA_COLUMN(int8_t, hit1isValid),
                      SOA_COLUMN(int8_t, hit2detectorID),
                      SOA_COLUMN(int8_t, hit2isValid),
